...
import Homework0524.LoginBean2;
...
public class Homework0522 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    response.sendRedirect("/example1/0523HomeWork/Login2.jsp");
	    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (checkIDPW(id, password)) {
            // 로그인 성공
              RequestDispatcher dispatcher = request.getRequestDispatcher("/0523Homework2/Main2.jsp");
              dispatcher.forward(request, response);
        } else {
            // 로그인 실패
       
              RequestDispatcher dispatcher = request.getRequestDispatcher("/0523Homework2/Error2.jsp");
              dispatcher.forward(request, response);
        }
    }
